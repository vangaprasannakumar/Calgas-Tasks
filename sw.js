// Service worker — app-shell caching, with a hard guarantee that ticket
...
//    fetched from the network and never cached — ticket data must never
//    come from a cache.
...
// in index.html.
const CACHE_VERSION = 'calgastasks-shell-v3';
...
self.addEventListener('fetch', (e) => {
  ...
  // Live ticket data — always network, never cached or served from cache.
